	...
	**/
	...
	public static TokenTypes matchTokenType(String value) {
		...
		try {
			...
			int i = Binary.stringToInt(value); //  1/6/05

			/***************************************************************************
			 *  MODIFICATION AND COMMENT, 3-July-2008
			 *
			...
			*        i = i - 65536;
			*     }
			*    // ------------- END     1/4/05   MODIFICATIONS --------------
			*
			 **************************  END 3-July-2008 COMMENTS *******************************/
	...
	//
	// 14-Jul-2008: added '$' as valid symbol.  Permits labels to include $.
