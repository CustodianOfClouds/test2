...
public class InstructionSet {
							...
							public void simulate(ProgramStatement statement) throws ProcessingException {
								...
								RegisterFile.updateRegister(operands[0],
										RegisterFile.getValue(
												operands[1]) << (RegisterFile.getValue(operands[2]) & 0x0000001F));
							}
						}));
		instructionList.add(
						...
						new SimulationCode() {
							public void simulate(ProgramStatement statement) throws ProcessingException {
								...
								if (value < 0.0f) {
									...
									// FCSR = Floating point unit Control and Status Register.  10-Aug-2010
				...
				new BasicInstruction("floor.w.s $f0,$f1",
						...
						new SimulationCode() {
							public void simulate(ProgramStatement statement) throws ProcessingException {
								...
								// 28-July-2010: Since MARS does not simulate the FSCR, I will take the default
						...
						new SimulationCode() {
							public void simulate(ProgramStatement statement) throws ProcessingException {
								...
								double doubleValue = Double.longBitsToDouble(Binary.twoIntsToLong(
										Coprocessor1.getValue(operands[1] + 1), Coprocessor1.getValue(operands[1])));
								// 27-July-2010: Since MARS does not simulate the FSCR, I will take the default
								// action of setting the result to 2^31-1, if the value is outside the 32 bit range.
				...
				new BasicInstruction("ldc1 $f2,-100($t2)",
						...
						new SimulationCode() {
							public void simulate(ProgramStatement statement) throws ProcessingException {
								...
								if (operands[0] % 2 == 1)
									throw new ProcessingException(statement, "first register must be even-numbered");
								// IF statement added by 13-July-2011.
	...
	*/
				...
				if (!line.startsWith("#") && !line.startsWith(" ")
					...
					while (tokenizer.hasMoreTokens()) {
						...
						if (token.startsWith("COMPACT")) {
							// has second template for Compact (16-bit) memory config -- added 3 Aug 2009
	 ...
	 */
	// 4 January 2008:  The subtraction of 4 bytes (instruction length) after
