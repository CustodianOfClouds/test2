...
public class TextSegmentWindow extends JPanel implements Observer {
	private JPanel programArgumentsPanel; // 17-July-2008
	private JTextField programArgumentsTextField; // 17-July-2008
	...
	public void setupTable() {
		...
		addressRows = new Hashtable<Integer, Integer>(data.length);
		...
		// source lines from all files.  3-Oct-10
	...
	////////////  Support for program arguments added 17-July-2008 //////////////
	/**
	...
	*/
	public void updateBasicStatements() {
		...
		for (int i = 0; i < sourceStatementList.size(); i++) {
			...
			// then display its basic code.  11-July-2013
	...
	*/
	...
	public void update(Observable observable, Object obj) {
		if (observable == mars.simulator.Simulator.getInstance()) {
			...
			if (notice.getAction() == SimulatorNotice.SIMULATOR_START) {
				...
				// even when running at unlimited speed.  10-July-2013
				deleteAsTextSegmentObserver();
	...
	public int[] getSortedBreakPointsArray() {
		...
		if (breakpointCount == 0 || !breakpointsEnabled) // added second condition 31-dec-09
			return null;
	...
	*/
	...
	class CheckBoxTableCellRenderer extends JCheckBox implements TableCellRenderer {
		...
		public CheckBoxTableCellRenderer() {
			...
			is why I'm dropping it for release 3.8.  31-dec-2009
	...
	private class MyTippedJTable extends JTable {
		...
		private class TextTableHeader extends JTableHeader {
			...
			// toggled (enabled/disabled).  31-Dec-2009
			private class TextTableHeaderMouseListener implements MouseListener {
				public void mouseClicked(MouseEvent e) {
					...
					if (realIndex == BREAK_COLUMN) {
						JCheckBox check = ((JCheckBox) ((DefaultCellEditor) table.getCellEditor(0, index))
								.getComponent());
