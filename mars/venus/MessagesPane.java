...
public class MessagesPane extends JTabbedPane implements Observer {
	...
	*/
	...
	private void setupFont() {
		Font sourceFont = Globals.getSettings().getEditorFont();
		sourceFont = (sourceFont.getStyle() == Font.PLAIN) ? sourceFont
				: new Font(sourceFont.getFamily(), Font.PLAIN, sourceFont.getSize());

		assemble.setFont(sourceFont);
		run.setFont(sourceFont);
	}
}
