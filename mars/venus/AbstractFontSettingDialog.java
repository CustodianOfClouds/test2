...
public abstract class AbstractFontSettingDialog extends JDialog {
	...
	*/
	...
	protected JPanel buildDialogPanel() {
		...
		fontFamilySelector = new JComboBox<String>(makeVectorData(fullList));
		...
		fontStyleSelector = new JComboBox<String>(fontStyles);
	...
	// within a combo box list. Code is old, 1999, but fine for this.
